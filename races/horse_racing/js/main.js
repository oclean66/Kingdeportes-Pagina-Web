...
(function() {
    var a = "undefined" !== typeof window && "undefined" !== typeof window.document ? window.document : {},
        ...
        l = {
            ...
            on: function(b, d) {
                var k = c[b];
                k && a.addEventListener(k, d, !1)
            },
            off: function(b,
                d) {
                var k = c[b];
                k && a.removeEventListener(k, d, !1)
            },
            raw: b
        };
...
(function() {
    ...
    function b(a, b) {
        for (var c in a) m.call(a, c) && b(a[c], c, a)
    }
    ...
    function h(a) {
            ...
            v = function(b) {
                return k(b, function(b, c) {
                    ...
                    if (!b && (b = RegExp("\\b" + k + "(?:/[\\d.]+|[ \\w.]*)", "i").exec(a))) {
                        ...
                        k && n && /^Win/i.test(g) && !/^Windows Phone /i.test(g) && (r = r[/[\d.]+$/.exec(g)]) && (g = "Windows " + r);
                        g = String(g);
                        k && n && (g = g.replace(RegExp(k, "i"), n));
        ...
        "IE" == t && /\blike iPhone OS\b/.test(a) ? (p = h(a.replace(/like iPhone OS/, "")), F = p.manufacturer, A = p.product) : /^iP/.test(A) ? (t || (t = "Safari"), v = "iOS" + ((p = / OS ([\d_]+)/i.exec(a)) ? " " + p[1].replace(/_/g, ".") : "")) : "Konqueror" != t || /buntu/i.test(v) ? F && "Google" != F && (/Chrome/.test(t) &&
        ...
        if ("Fennec" == t || "Firefox" == t && /\b(?:Android|Firefox OS)\b/.test(v)) t = "Firefox Mobile";
            ...
            if ("IE" == t && K) try {
                ...
                h.call(b, a.replace(u, "") + ";")) && p.name && (p = "ing as " + p.name + ((p = p.version) ? " " + p : ""), u.test(t) ? (/\bIE\b/.test(p) && "Mac OS" == v && (v = null), p = "identify" + p) : (p = "mask" + p, t = M ? d(M.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera", /\bIE\b/.test(p) && (v = null), K || (m = null)), z = ["Presto"], q.push(p));
            else t += " Mobile";
    ...
    var q = r && g && "object" == typeof global && global;
...
function CGameSettings(a) {
    var e, d, b, c, l, f, k, h, g;
    this._init = function(a) {
        g = a;
        a = g.horse_names;
        NUM_HORSES = a.length;
        e = [];
        for (var b = 0; b < NUM_HORSES; b++) e[b] = a[b];
        this._initSimpleOdd();
    ...
    this._initForecastOdd = function() {
        var a = g.forecast;
        l = [];
        for (var b = 0; b < NUM_HORSES; b++) l[b] = [];
        for (b = 0; b < a.length; b++) l[a[b].first - 1][a[b].second - 1] = a[b].odd
    };
    ...
    this.getIndexForFiches = function(a) {
        for (var b = 0, c = 0; c < f.length; c++) f[c] === a && (b = c);
        return b
    };
    this.getHorsePercentageArray = function() {
        for (var a = [], b = 0; b < d.length; b++)
            for (var c = Math.floor(d[b]), g = 0; g < c; g++) a.push(b);
        return a = shuffle(a)
    };
    this.getHorseName = function(a) {
        return e[a]
    };
    this.getAllHorseNames = function() {
        return e
    };
    this.getOddWin = function(a) {
        return d[a]
    };
    this.getOddPlace = function(a) {
        return b[a]
    };
    this.getOddShow = function(a) {
        return c[a]
    };
    this.getForecastOdd =
        function(a, b) {
...
function CPreloader() {
    ...
    this.attachSprites = function() {
        ...
        h = new CTextButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT /
            2 + 40, n, TEXT_PRELOADER_CONTINUE, "Arial", "#000", 50, g);
    ...
    this.refreshLoader = function(g) {
        d.text = g + "%";
        100 === g && (s_oMain._onRemovePreloader(), d.visible = !1, b.visible = !1);
        c.graphics.clear();
        g = Math.floor(g * a / 100);
        c.graphics.beginFill("rgba(0,0,0,0.01)").drawRect(b.x, b.y, g, e)
    };
    this._init()
}
...
function CMain(a) {
    ...
    this.initContainer = function() {
        ...
        !1 === s_bMobile && (s_oStage.enableMouseOver(10), $("body").on("contextmenu", "#canvas", function(a) {
            return !1
        }));
        ...
        l = new CPreloader 
        // seekAndDestroy() ? l = new CPreloader : window.location.href = "http://www.codethislab.com/contact-us.html"
    };
    ...
    this._loadImages = function() {
        ...
        s_oSpriteLibrary.addSprite("fiche_3",
            "./sprites/fiche_3.png");
        ...
        s_oSpriteLibrary.addSprite("but_start_race",
        ...
        for (var a = 0; a < NUM_HORSES; a++) s_oSpriteLibrary.addSprite("bib_gui_" + a, "./sprites/bib_gui_" + a + ".png"), s_oSpriteLibrary.addSprite("horse_" +
            (a + 1) + "_a", "./sprites/horse_" + (a + 1) + "_a.png"), s_oSpriteLibrary.addSprite("horse_" + (a + 1) + "_b", "./sprites/horse_" + (a + 1) + "_b.png"), s_oSpriteLibrary.addSprite("cage_" + a, "./sprites/cage_" + a + ".png"), s_oSpriteLibrary.addSprite("gate_" + a, "./sprites/cage_gates/gate_" + a + ".png");
...
function CTextButton(a, e, d, b, c, l, f, k) {
    var h, g, n, r, q, x, u, m, y, w;
    this._init = function(a, b, c, d, f, e, q) {
        h = !1;
        g = 1;
        n = [];
        r = [];
    ...
    this.buttonRelease = function() {
        h || (playSound("click", 1, !1), m.scaleX = g, m.scaleY = g, n[ON_MOUSE_UP] && n[ON_MOUSE_UP].call(r[ON_MOUSE_UP],
            u))
    };
    this.buttonDown = function() {
        h || (m.scaleX = .9 * g, m.scaleY = .9 * g, n[ON_MOUSE_DOWN] && n[ON_MOUSE_DOWN].call(r[ON_MOUSE_DOWN]))
    };
    this.setPosition = function(a, b) {
        m.x = a;
        m.y = b
    };
    this.tweenPosition = function(a, b, c, d, g, f, e) {
...
function CToggle(a, e, d, b, c) {
    ...
    this._init = function(a, b, c, d, g) {
        ...
        l = d;
        h = createSprite(g, "state_" + l, c.width / 2 / 2, c.height / 2, c.width / 2, c.height);
        h.x = a;
        h.y = b;
        h.stop();
    ...
    this._initListener = function() {
        g = h.on("mousedown", this.buttonDown);
        n = h.on("pressup", this.buttonRelease)
    };
    this.addEventListener = function(a, b, c) {
        f[a] = b;
        k[a] = c
...
function CGfxButton(a, e, d, b) {
    ...
    this.buttonRelease = function() {
        q || (f.scaleX = 0 < h ? h : -h, f.scaleY = g, playSound("click", 1, 0), c[ON_MOUSE_UP] && c[ON_MOUSE_UP].call(l[ON_MOUSE_UP], k[ON_MOUSE_UP]))
    };
    this.buttonDown = function() {
        q || (f.scaleX = 0 < h ? .9 * h : .9 * -h, f.scaleY = .9 * g, c[ON_MOUSE_DOWN] && c[ON_MOUSE_DOWN].call(l[ON_MOUSE_DOWN], k[ON_MOUSE_DOWN]))
    };
...
function CMenu() {
    var a, e, d, b, c, l, f, k, h, g, n, r, q, x, u, m = null,
        y, w = null,
        C = null,
        B;
    this._init = function() {
        ...
        h = CANVAS_WIDTH / 2;
        g = CANVAS_HEIGHT - m.height / 2 - 10;
        r = new CGfxButton(h, g, m);
...
function CGame(a) {
    var e, d, b, c, l, f, k, h, g, n, r, q, x, u, m, y, w, C, B, G;
    this._init = function() {
        c = b = e = !1;
        k = f = 0;
    ...
    this.pause = function() {
        ...
        for (var a = 0; a < NUM_HORSES; a++) n[a].pauseAnim()
    };
    this.unpause = function() {
        e = !0;
        playSound("start_race");
        for (var a = 0; a < NUM_HORSES; a++) n[a].unpauseAnim()
    };
    ...
    this.startRace = function() {
        for (var a = 0; a < q.length; a++) q[a].playAnim();
        w.blockExit(!1);
        e = !0;
        y.startTrack();
        setTimeout(function() {
    ...
    this._generateRandomRank = function() {
        for (var a = [], b = s_oGameSettings.getHorsePercentageArray(); a.length < NUM_HORSES;) {
            var c = b[Math.floor(Math.random() * b.length)];
            a.unshift(c);
            for (var d = b.length - 1; 0 <= d;) b[d] === c && b.splice(d, 1), d--
        }
        return a
    };
    this._prepareHorses = function() {
        ...
        q = [];
        n = [];
        for (var a = s_oGameSettings.getRandomPath(),
                b = [{
                    x: 266,
                    y: 233
                }, {
            ...
            var g = h.indexOf(c);
            n[c] = new CHorse(d.start, c + 1, x[c], d.scale, a["place_" + (g + 1)], u);
            d = new CGate(b[c].x, b[c].y, c, u);
            q.push(d)
        }
        d = createBitmap(s_oSpriteLibrary.getSprite("cage_" + NUM_HORSES));
        u.addChild(d);
        r.push(d);
        d = new CGate(b[NUM_HORSES].x,
            b[NUM_HORSES].y, NUM_HORSES, u);
        q.push(d)
    };
    this.startHorses = function() {
        for (var a = 0; a < NUM_HORSES; a++) n[a].startRace()
    };
    this.horsePhotofinish = function(a, b) {
        w.blockExit(!0);
        B.refreshRank(a, b);
        f++;
        4 > f ? (e = !1, k = TIME_CHECK_RANK, this._playFlashAnim()) : 6 === f && (d || 0 < l ? (s_iCurMoney += l, s_iGameCash -= l, s_iCurMoney = parseFloat(s_iCurMoney.toFixed(2)), s_iGameCash = parseFloat(s_iGameCash.toFixed(2)), w.showWinPanel(l, g, h)) : w.showLosePanel(h), stopSound("start_race"), setVolume("soundtrack", 1), $(s_oMain).trigger("save_score",
            s_iCurMoney))
    };
    ...
    this.restoreRaceAfterFlash = function() {
        setTimeout(function() {
            for (var a =
                    0; a < NUM_HORSES; a++) n[a].unpauseAnim();
            u.filters = [];
            u.cache(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
            e = !0
        }, 1E3)
    };
    this.moveCages = function(a) {
        if (4 === a) {
            for (var b = 0; b < r.length; b++) u.removeChild(r[b]);
            for (b = 0; b < q.length; b++) q[b].unload()
        } else {
            var c = [123, 255, 370];
            for (b = 0; b < r.length; b++) r[b].x -= c[a - 1];
            for (b = 0; b < q.length; b++) q[b].decreaseX(c[a - 1])
        }
    };
    this._refreshRank = function() {
        for (var a = [], b = 0; b < NUM_HORSES; b++) {
            var c = n[b].getX();
            a[b] = {
                index: b,
                x: c
...
function CInterface() {
    ...
    this._init = function() {
        ...
        h = m.requestFullscreen || m.mozRequestFullScreen || m.webkitRequestFullScreen || m.msRequestFullscreen;
        g = u.exitFullscreen || u.mozCancelFullScreen || u.webkitExitFullscreen || u.msExitFullscreen;
        !1 === ENABLE_FULLSCREEN && (h = !1);
        h && screenfull.enabled && (u = s_oSpriteLibrary.getSprite("but_fullscreen"), k = new CToggle(d, b, u, s_bFullscreen, s_oStage), k.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease, this));
    ...
    this.refreshButtonPos = function() {
        ...
        h && screenfull.enabled && k.setPosition(d - s_iOffsetX, b + s_iOffsetY);
        n.setPosition(a - s_iOffsetX, e + s_iOffsetY)
    };
    this.showWinPanel = function(a, b, c) {
        r.show(a, b, c)
    };
    this.showLosePanel = function(a) {
        q.show(a)
    };
    this.unload = function() {
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) f.unload(), f = null;
        h && screenfull.enabled && k.unload();
        r.unload();
        q.unload();
        x.unload();
        s_oInterface = null
    ...
    this.resetFullscreenBut = function() {
        h && screenfull.enabled && k.setActive(s_bFullscreen)
    };
    this._onFullscreenRelease = function() {
...
function CBetPanel() {
    var a, e, d, b, c, l, f, k, h, g, n, r, q = null,
        x = null,
        u, m, y, w, C, B, G, E, I;
    this._init = function() {
        h = f = 0;
        ...
        I.addChild(E);
        g = [];
        g[0] = new CSimpleBetPanel(0, 0, E);
        g[1] = new CForecastPanel(BET_PANEL_WIDTH, 0, E);
    ...
    this.setForecastBet = function(a, b, c, d) {
        if (c > s_iCurMoney) return C.show(TEXT_NO_MONEY, !0), !1;
        if (f + c > MAX_BET) return C.show(TEXT_ERR_MAX_BET, !1), !1;
        s_oBetList.addForecastBet(a, b, c);
        f += c;
        f = Number(f.toFixed(2));
        s_iCurMoney -=
            c;
    ...
    this.refreshPagePos = function(a, b) {
        E.x = BET_PANEL_X;
        g[k].setX(0);
        g[a].setX(b)
    };
    this.clearBet = function() {
        for (var a = 0; a < n.length; a++) n[a].clearBet();
        s_iCurMoney += f;
        s_iCurMoney = parseFloat(s_iCurMoney.toFixed(2));
        s_iGameCash -= f;
...
function CChipPanel(a, e, d) {
    ...
    this._init = function(a, b) {
        ...
        g.y = b;
        n.addChild(g);
        h = new CTextButton(73, 2, s_oSpriteLibrary.getSprite("but_clear_bet"), TEXT_CLEAR_BET, PRIMARY_FONT, "#fff", 24, g);
        h.addEventListener(ON_MOUSE_UP, this._onClearBet, this);
        ...
        d.y = 22;
        g.addChild(d);
        new CTLText(g, 18, 32, 110, 14, 14, "center", "#ffde00", SECONDARY_FONT, 1, 0,
            0, TEXT_MIN_BET + ": " + MIN_BET + TEXT_CURRENCY, !0, !0, !1, !1);
        new CTLText(g, 18, 44, 110, 14, 14, "center", "#ffde00", SECONDARY_FONT, 1, 0, 0, TEXT_MAX_BET + ": " + MAX_BET + TEXT_CURRENCY, !0, !0, !1, !1);
        d = createBitmap(s_oSpriteLibrary.getSprite("money_panel"));
        d.regX = c.width / 2;
        d.x = 73;
        d.y = 72;
        g.addChild(d);
        new CTLText(g, 5, 74, 40, 12, 12, "left", "#fff", TERTIARY_FONT, 1, 0, 0, TEXT_BET, !0, !0, !1, !1);
        f = new CTLText(g, 18, 82, 110, 26, 26, "center", "#ffde00", SECONDARY_FONT, 1, 0, 0, "0" + TEXT_CURRENCY, !0, !0, !1, !1);
        d = createBitmap(c);
        d.regX = c.width /
            2;
        d.x = 73;
        d.y = 122;
        g.addChild(d);
        new CTLText(g, 5, 124, 40, 12, 12, "left", "#fff", TERTIARY_FONT, 1, 0, 0, TEXT_MONEY, !0, !0, !1, !1);
        l = new CTLText(g, 18, 132, 110, 26, 26, "center", "#ffde00", SECONDARY_FONT, 1, 0, 0, s_iCurMoney + TEXT_CURRENCY, !0, !0, !1, !1);
        this._initChips();
        k = new CButStartRace(73, 304, s_oSpriteLibrary.getSprite("but_start_race"), TEXT_START_RACE, "#fff", 24, g);
    ...
    this._initChips = function() {
        ...
        b = [];
        for (var d = 0; d < NUM_CHIPS; d++) b[d] = new CFicheBut(d, a[d].x, a[d].y, 1, g), b[d].addEventListenerWithParams(ON_MOUSE_UP, this._onFicheClicked, this, d);
...
function CSimpleBetPanel(a, e, d) {
    ...
    this._init = function(a, b) {
        ...
        for (var d = new createjs.SpriteSheet({
            ...
            }), g = 35, f = 23, e = 0; e < NUM_HORSES; e++) {
            var n = createSprite(d, "bib_" + e, 0, 0, c.width / 3, c.height / 2);
            n.x = f;
            n.y = g;
            n.scaleX = n.scaleY = .5;
            k.addChild(n);
            e === NUM_HORSES / 2 - 1 ? (f = 470, g = 35) : g += c.height / 2 + 45
        }
    ...
    this._initHorseInfos = function() {
        ...
        for (var c = 18, d = 55, f = 0; f < NUM_HORSES; f++) {
            var e = s_oSpriteLibrary.getSprite("horse_" +
                    (f + 1) + "_a"),
                h = s_oSpriteLibrary.getSprite("horse_" + (f + 1) + "_b");
    ...
    this._initBetPlaces = function() {
        ...
        f = [];
        c = [];
        for (var a = 150, b = 75, d = s_oSpriteLibrary.getSprite("bet_place"), e = 0; e < NUM_HORSES; e++) {
            var h =
            ...
            h.y = b + 54;
            k.addChild(h);
            h = new CButBet(h.x + 2, b, d, .7, k);
            h.addEventListenerWithParams(ON_MOUSE_UP, this._onWinClicked, this, e);
            c.push(h);
            h = new createjs.Text(s_oGameSettings.getOddPlace(e), "20px " + PRIMARY_FONT, "#fff");
            h.textAlign = "center";
            h.textBaseline = "middle";
            h.x = a + 150;
            h.y = b + 54;
            k.addChild(h);
            h = new CButBet(h.x + 2, b, d, .7, k);
            h.addEventListenerWithParams(ON_MOUSE_UP, this._onPlaceClicked,
                this, e);
            l.push(h);
            h = new createjs.Text(s_oGameSettings.getOddShow(e), "20px " + PRIMARY_FONT, "#fff");
            h.textAlign = "center";
            h.textBaseline = "middle";
            h.x = a + 260;
            h.y = b + 54;
            k.addChild(h);
            h = new CButBet(h.x + 2, b, d, .7, k);
            h.addEventListenerWithParams(ON_MOUSE_UP, this._onShowClicked, this, e);
            f.push(h);
            e === NUM_HORSES / 2 - 1 ? (a = 596, b = 75) : b += 116
        }
    };
    this.unload = function() {
        for (var a = 0; a < l.length; a++) c[a].unload(), f[a].unload(), l[a].unload()
    };
    this.setX = function(a) {
        k.x = a
    };
...
function CForecastPanel(a, e, d) {
    ...
    this._placeForecastBetForHorse = function(a, d, e) {
        var f = s_oSpriteLibrary.getSprite("odd_bg"),
            ...
            k = s_oSpriteLibrary.getSprite("bibs"),
            l = k.width / 4,
            x = k.height / 2;
        ...
        for (var u = 0; u < NUM_HORSES; u++)
            if (u !== a) {
                var m = createSprite(k, "bib_" + a, 0, 0, l, x);
                m.x = d;
                m.y = e;
                ...
                y.y = e + .55 * x / 2;
                c.addChild(y);
                var w = createSprite(k, "bib_" + u, 0, 0, l / 3, x / 2);
                w.x = y.x + 10;
                w.y = m.y;
                ...
                c.addChild(m);
                m = new CButBet(y.x +
                    f.width + .72 * h.width / 2 + 5, y.y + .72 * h.height / 2 - 2, h, .45, c);
                m.setScale(.6);
...
function CBetList() {
    ...
    this.addForecastBet = function(a, c, l) {
        e[a][c] += l;
        d.push({
            type_bet: "forecast",
            horses: [{
            ...
            bet: l,
            win: l * s_oGameSettings.getForecastOdd(a, c)
        })
    };
    this.getMinWin = function() {
        if (0 < d.length) {
            for (var a = d[0].win, c = 1; c < d.length; c++) a > d[c].win && (a = d[c].win);
            return a
        }
        return 0
    };
...
function CFichesController(a, e) {
    ...
    this.refreshFiches = function(b, d, e) {
        ...
        for (var f = d + FICHE_WIDTH * a / 2, g = e + FICHE_WIDTH * a / 2, h = c = 0, k = 0; k < b.length; k++)(new CFicheBut(b[k].index, f, g, a, n)).disable(), g -= 5, h++, 9 < h && (h = 0, f += FICHE_WIDTH, g = e), c += b[k].value;
        playSound("chip", 1, 0);
        q.x = d;
        q.y = e + 25 * l;
    ...
    this.createFichesPile = function(a, b, c) {
        ...
        do {
            for (var f =
                    d[d.length - 1], g = d.length - 1; f > a;) g--, f = d[g];
            g = Math.floor(a / f);
        ...
        this.refreshFiches(e, b, c * l)
    };
    this.initMovement = function(a, b) {
        f = c;
        h = new CVector2(n.x, n.y);
        g = new CVector2(a, b);
        q.text = "";
        x.text = "";
        d = !0
...
function CButBet(a, e, d, b, c) {
    ...
    this.buttonRelease = function() {
        u || (h.scaleX = 0 < n ? n : -n, h.scaleY = r, playSound("chip", 1, 0), f[ON_MOUSE_UP] && f[ON_MOUSE_UP].call(k[ON_MOUSE_UP], g[ON_MOUSE_UP]))
    };
    this.buttonDown = function() {
        u || (h.scaleX = 0 < n ? .9 * n : .9 * -n, h.scaleY = .9 * r, f[ON_MOUSE_DOWN] && f[ON_MOUSE_DOWN].call(k[ON_MOUSE_DOWN], g[ON_MOUSE_DOWN]))
    };
    this.rotation =
        function(a) {
            h.rotation = a
...
function CTrackBg(a) {
    ...
    this._init = function() {
        ...
        for (var a = 0; a < NUM_TRACK_BG; a++) {
            var g = createBitmap(s_oSpriteLibrary.getSprite("bg_track_" + a));
...
function CHorse(a, e, d, b, c, l) {
    ...
    this.update = function(a) {
        if (f) {
            g++;
            if (g >= n) q++, q < m.length ? (g = 0, n = m[q].frame, r = w.x) : f = !1;
            else {
                var b = s_oTweenController.easeLinear(g, 0, 1, n);
                b = s_oTweenController.tweenValue(r, m[q].x, b);
                w.x = b
            }
            a && !k && w.x >= x && (k = !0, s_oGame.horsePhotofinish(h - 1, u))
        }
    };
    var C = l;
    this._init(a, e, d, b, c)
...
function CRankingGui(a, e) {
    ...
    this._init = function(a) {
        ...
        h.graphics.beginFill("rgba(255,255,255,0.01)").drawRect(k.x, k.y - 2, .01, 10);
        g.addChild(h);
        k.mask = h;
        this.refreshButtonPos()
    };
    ...
    this.refreshRadar = function(a) {
        h.graphics.clear();
        h.graphics.beginFill("rgba(255,255,255,0.01)").drawRect(k.x, k.y - 2, c * a, 10)
    };
    var n = e;
    this._init(a)
}
...
function CWinPanel(a) {
    ...
    this.show = function(a, c, h) {
        f.refreshText(TEXT_WIN + "\n" + a + TEXT_CURRENCY);
        a = 240;
        for (var g = 0; 3 > g; g++) {
            var l = s_oSpriteLibrary.getSprite("horse_" + (h[g] + 1) + "_a"),
                n = s_oSpriteLibrary.getSprite("horse_" + (h[g] + 1) + "_b");
        ...
        for (h = 0; h < c.length; h++) "forecast" === c[h].type ? (l = c[h].horses, n = createSprite(b, "bib_" + l[0], 0, 0, e, d), n.x = 380, n.y = a, n.scaleX = n.scaleY = .5, k.addChild(n), g = new createjs.Text("X", "20px " + PRIMARY_FONT, "#fff"), g.textAlign = "center", g.textBaseline = "middle", g.x = n.x + .5 * e + 10, g.y = a + 18, k.addChild(g), l = createSprite(b, "bib_" + l[1], 0, 0, e, d), l.x = g.x + 10, l.y = a, l.scaleX = l.scaleY = .5, k.addChild(l), g = l.x + 35) :
            (n = createSprite(b, "bib_" + c[h].horses, 0, 0, e, d), n.x = 380, n.y = a, n.scaleX = n.scaleY = .5, k.addChild(n), g = n.x + 35), new CTLText(k, g, a + 8, 80, 20, 20, "left", "#ffb400", PRIMARY_FONT, 1, 0, 0, c[h].type.toUpperCase(), !0, !0, !1, !1), new CTLText(k, g + 84, a + 8, 80, 20, 20, "left", "#fff", PRIMARY_FONT, 1, 0, 0, TEXT_WIN + ": " + c[h].win + TEXT_CURRENCY, !0, !0, !1, !1), a += 35;
        k.visible = !0;
        k.alpha = 0;
...
function CTLText(a, e, d, b, c, l, f, k, h, g, n, r, q, x, u, m, y) {
    this._oContainer = a;
    this._x = e;
    this._y = d;
    this._iWidth = b;
...
function CFicheBut(a, e, d, b, c) {
    ...
    this._init = function(d, e) {
        var h = s_oSpriteLibrary.getSprite("fiche_" + a);
        l = !1;
        n = new createjs.Container;
        n.x = d;
        n.y = e;
    ...
    this.buttonRelease = function() {
        l || (playSound("click", 1, !1), n.scaleX = b, n.scaleY =
            b, f[ON_MOUSE_UP] && f[ON_MOUSE_UP].call(k[ON_MOUSE_UP], h))
    };
    this.buttonDown = function() {
        l || (n.scaleX = .9 * b, n.scaleY = .9 * b, f[ON_MOUSE_DOWN] && f[ON_MOUSE_DOWN].call(k[ON_MOUSE_DOWN], h))
    };
    this.setPosition = function(a, b) {
        n.x = a;
        n.y = b
