...
TEXT_YOU_WIN = "GANO";
TEXT_YOU_LOSE = "PERDIO";
TEXT_CURRENCY = "$";
var TEXT_PRELOADER_CONTINUE = "EMPEZAR";
TEXT_ERROR_NO_MONEY_MSG = "SALDO INSUFICIENTE PARA ESTA APUESTA!!";
TEXT_ERROR_MAX_BET_REACHED = "APUESTA MAX SUPERADA!!";
TEXT_ERROR_MIN_BET = "APUESTA INSUFICIENTE!!";
TEXT_NO_MONEY = "SALDO INSUFICIENTE!!!";
TEXT_RECHARGE_MSG = "POR FAVOR RECARGUE SALDO";
var TEXT_CREDITS_DEVELOPED = "DESARROLLADO POR",
