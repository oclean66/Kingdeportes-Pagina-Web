    ...
    var a = "undefined" !== typeof window && "undefined" !== typeof window.document ? window.document : {},
        ...
        f = function() {
            for (var c, b = ["requestFullscreen exitFullscreen fullscreenElement fullscreenEnabled fullscreenchange fullscreenerror".split(" "), "webkitRequestFullscreen webkitExitFullscreen webkitFullscreenElement webkitFullscreenEnabled webkitfullscreenchange webkitfullscreenerror".split(" "),
                ...
                ], e = 0, d = b.length, f = {}; e < d; e++)
                if ((c = b[e]) && c[1] in a) {
                    for (e = 0; e < c.length; e++) f[b[0][e]] =
                        c[e];
                    return f
                }
            return !1
    ...
    function e(a) {
        function d(d) {
            return m(d, function(d, b) {
                var r = b.pattern || h(b);
                !d && (d = RegExp("\\b" + r + " *\\d+[.\\w_]*", "i").exec(a) || RegExp("\\b" + r + " *\\w+-[\\w]*", "i").exec(a) || RegExp("\\b" + r + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)", "i").exec(a)) && ((d = String(b.label && !RegExp(r, "i").test(b.label) ? b.label : d).split("/"))[1] && !/[\d.]+/.test(d[0]) && (d[0] +=
                    " " + d[1]), b = b.label || b, d = c(d[0].replace(RegExp(r, "i"), b).replace(RegExp("; *(?:" + b + "[_-])?", "i"), " ").replace(RegExp("(" + b + ")[-_.]?(\\w)", "i"), "$1 $2")));
                return d
            })
        }
        ...
        var C = function(d) {
                return m(d, function(d, b) {
                    return d || RegExp("\\b" + (b.pattern || h(b)) + "\\b", "i").exec(a) && (b.label ||
                        b)
                })
            }([{
                label: "EdgeHTML",
            ...
            v = function(d) {
                return m(d, function(d, b) {
                    ...
                    if (!d && (d = RegExp("\\b" + r + "(?:/[\\d.]+|[ \\w.]*)", "i").exec(a))) {
                        ...
                        d = e = c(e.replace(/ ce$/i, " CE").replace(/\bhpw/i, "web").replace(/\bMacintosh\b/, "Mac OS").replace(/_PowerPC\b/i, " OS").replace(/\b(OS X) [^ \d]+/i, "$1").replace(/\bMac (OS X)\b/, "$1").replace(/\/(\d)/,
        ...
        "IE" == u && /\blike iPhone OS\b/.test(a) ? (g = e(a.replace(/like iPhone OS/, "")), F = g.manufacturer, D = g.product) : /^iP/.test(D) ? (u || (u = "Safari"), v = "iOS" + ((g = / OS ([\d_]+)/i.exec(a)) ? " " + g[1].replace(/_/g, ".") : "")) : "Konqueror" != u || /buntu/i.test(v) ? F && "Google" != F && (/Chrome/.test(u) &&
            ...
            /\b(?:Firefox|Safari)\b/.exec(u)) ? (u && !D && /[\/,]|^[^(]+?\)/.test(a.slice(a.indexOf(g + "/") + 8)) && (u = null), (g = D || F || v) && (D || F || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(v)) && (u = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(v) ? v : g) + " Browser")) : "Electron" == u && (g = (/\bChrome\/([\d.]+)\b/.exec(a) || 0)[1]) && l.push("Chromium " + g) : v = "Kubuntu";
        ...
        if (H) {
            if (n(t, "global"))
                if (K && (g = K.lang.System, P = g.getProperty("os.arch"), v = v || g.getProperty("os.name") + " " + g.getProperty("os.version")), R) {
                    try {
                        r = t.require("ringo/engine").version.join("."), u = "RingoJS"
                    } catch (T) {
                        (g = t.system) && g.global.system == t.system && (u = "Narwhal", v || (v = g[0].os || null))
                    }
                    u || (u = "Rhino")
                } else "object" == typeof t.process &&
                    !t.process.browser && (g = t.process) && ("object" == typeof g.versions && ("string" == typeof g.versions.electron ? (l.push("Node " + g.versions.node), u = "Electron", r = g.versions.electron) : "string" == typeof g.versions.nw && (l.push("Chromium " + r, "Node " + g.versions.node), u = "NW.js", r = g.versions.nw)), u || (u = "Node.js", P = g.arch, v = g.platform, r = (r = /[\d.]+/.exec(g.version)) ? r[0] : null));
            else k(g = t.runtime) == J ? (u = "Adobe AIR", v = g.flash.system.Capabilities.os) : k(g = t.phantom) == q ? (u = "PhantomJS", r = (g = g.version || null) && g.major + "." + g.minor +
                "." + g.patch) : "number" == typeof A.documentMode && (g = /\bTrident\/(\d+)/i.exec(a)) ? (r = [r, A.documentMode], (g = +g[1] + 4) != r[1] && (l.push("IE " + r[1] + " mode"), C && (C[1] = ""), r[1] = g), r = "IE" == u ? String(r[1].toFixed(1)) : r[0]) : "number" == typeof A.documentMode && /^(?:Chrome|Firefox)\b/.test(u) && (l.push("masking as " + u + " " + r), u = "IE", r = "11.0", C = ["Trident"], v = "Windows");
            v = v && c(v)
        }
        r && (g = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(r) || /(?:alpha|beta)(?: ?\d)?/i.exec(a + ";" + (H && y.appMinorVersion)) || /\bMinefield\b/i.test(a) &&
            "a") && (Q = /b/i.test(g) ? "beta" : "alpha", r = r.replace(RegExp(g + "\\+?$"), "") + ("beta" == Q ? x : E) + (/\d+\+?/.exec(g) || ""));
        if ("Fennec" == u || "Firefox" == u && /\b(?:Android|Firefox OS)\b/.test(v)) u = "Firefox Mobile";
            ...
            if ("IE" == u && H) try {
                ...
                l.unshift("embedded")
            } else(/\bBlackBerry\b/.test(D) || /\bBB10\b/.test(a)) && (g = (RegExp(D.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(a) || 0)[1] || r) ? (g = [g, /BB10/.test(a)], v = (g[1] ? (D = null, F = "BlackBerry") : "Device Software") + " " + g[0], r = null) : this != f && "Wii" != D && (H && z || /Opera/.test(u) && /\b(?:MSIE|Firefox)\b/i.test(a) || "Firefox" == u && /\bOS X (?:\d+\.){2,}/.test(v) || "IE" == u && (v && !/^Win/.test(v) && 5.5 < r || /\bWindows XP\b/.test(v) && 8 < r || 8 == r && !/\bTrident\b/.test(a))) && !w.test(g =
                e.call(f, a.replace(w, "") + ";")) && g.name && (g = "ing as " + g.name + ((g = g.version) ? " " + g : ""), w.test(u) ? (/\bIE\b/.test(g) && "Mac OS" == v && (v = null), g = "identify" + g) : (g = "mask" + g, u = O ? c(O.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera", /\bIE\b/.test(g) && (v = null), H || (r = null)), C = ["Presto"], l.push(g));
            else u += " Mobile";
        if (g = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(a) || 0)[1]) {
            g = [parseFloat(g.replace(/\.(\d)$/, ".0$1")), g];
            if ("Safari" == u && "+" == g[1].slice(-1)) u = "WebKit Nightly", Q = "alpha", r = g[1].slice(0, -1);
            else if (r == g[1] || r == (g[2] =
                    (/\bSafari\/([\d.]+\+?)/i.exec(a) || 0)[1])) r = null;
            g[1] = (/\bChrome\/([\d.]+)/i.exec(a) || 0)[1];
            537.36 == g[0] && 537.36 == g[2] && 28 <= parseFloat(g[1]) && "WebKit" == C && (C = ["Blink"]);
            H && (I || g[1]) ? (C && (C[1] = "like Chrome"), g = g[1] || (g = g[0], 530 > g ? 1 : 532 > g ? 2 : 532.05 > g ? 3 : 533 > g ? 4 : 534.03 > g ? 5 : 534.07 > g ? 6 : 534.1 > g ? 7 : 534.13 > g ? 8 : 534.16 > g ? 9 : 534.24 > g ? 10 : 534.3 > g ? 11 : 535.01 > g ? 12 : 535.02 > g ? "13+" : 535.07 > g ? 15 : 535.11 > g ? 16 : 535.19 > g ? 17 : 536.05 > g ? 18 : 536.1 > g ? 19 : 537.01 > g ? 20 : 537.11 > g ? "21+" : 537.13 > g ? 23 : 537.18 > g ? 24 : 537.24 > g ? 25 : 537.36 > g ? 26 : "Blink" !=
        ...
        "Opera" == u && (g = /\bzbov|zvav$/.exec(v)) ? (u += " ", l.unshift("desktop mode"), "zvav" == g ? (u += "Mini", r = null) : u += "Mobile", v = v.replace(RegExp(" *" + g + "$"), "")) : "Safari" == u && /\bChrome\b/.exec(C && C[1]) && (l.unshift("desktop mode"), u = "Chrome Mobile", r = null, /\bOS X\b/.test(v) ? (F =
        ...
        }(g = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(P)) && !/\bi686\b/i.test(P) ? (v && (v.architecture = 64, v.family = v.family.replace(RegExp(" *" + g), "")), u && (/\bWOW64\b/i.test(a) || H && /\w(?:86|32)$/.test(y.cpuClass || y.platform) && !/\bWin64; x64\b/i.test(a)) &&
...
function sizeHandler() {
    ...
    if ($("#canvas")) {
        ...
        } else f < b && (k = b - f, f += k, c += CANVAS_HEIGHT / CANVAS_WIDTH * k);
        k = a / 2 - c / 2;
        var n = b / 2 - f / 2,
            h = CANVAS_WIDTH / f;
        if (n * h < -EDGEBOARD_X || k * h < -EDGEBOARD_Y) c = Math.min(a / (CANVAS_HEIGHT - 2 * EDGEBOARD_Y),
            b / (CANVAS_WIDTH - 2 * EDGEBOARD_X)), f = CANVAS_WIDTH * c, c *= CANVAS_HEIGHT, k = (a - c) / 2, n = (b - f) / 2, h = CANVAS_WIDTH / f;
        s_iOffsetX = -1 * n * h;
        s_iOffsetY = -1 * k * h;
        0 <= k && (s_iOffsetY = 0);
        0 <= n && (s_iOffsetX = 0);
        ...
        s_bIsIphone ? (canvas = document.getElementById("canvas"), s_oStage.canvas.width = 2 * f, s_oStage.canvas.height = 2 * c, canvas.style.width = f + "px", canvas.style.height = c + "px", b = Math.min(f / CANVAS_WIDTH,
            c / CANVAS_HEIGHT), s_iScaleFactor = 2 * b, s_oStage.scaleX = s_oStage.scaleY = 2 * b) : s_bMobile || isChrome() ? ($("#canvas").css("width", f + "px"), $("#canvas").css("height", c + "px")) : (s_oStage.canvas.width = f, s_oStage.canvas.height = c, s_iScaleFactor = Math.min(f / CANVAS_WIDTH, c / CANVAS_HEIGHT), s_oStage.scaleX = s_oStage.scaleY = s_iScaleFactor);
        0 > k || (k = (a - c) / 2);
        $("#canvas").css("top", k + "px");
...
function CPreloader() {
    ...
    this.attachSprites = function() {
        ...
        e = new CTextButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT /
            2 + 40, p, TEXT_PRELOADER_CONTINUE, "Arial", "#000", 50, d);
    ...
    this.refreshLoader = function(d) {
        c.text = d + "%";
        100 === d && (s_oMain._onRemovePreloader(), c.visible = !1, f.visible = !1);
        k.graphics.clear();
...
function CMain(a) {
    ...
    this.initContainer = function() {
        ...
        n = new CPreloader
        // seekAndDestroy() ?
        //     n = new CPreloader : window.location.href = "http://www.codethislab.com/contact-us.html"
    };
    ...
    this._loadImages = function() {
        ...
        for (a = 1; a < NUM_PAYLINES +
            1; a++) s_oSpriteLibrary.addSprite("payline_" + a, "./sprites/payline_" + a + ".png");
...
function CTextButton(a, b, c, f, k, n, h, m) {
    ...
    this.buttonRelease = function() {
        e || (playSound("press_but", 1, !1), x.scaleX = d, x.scaleY = d, p[ON_MOUSE_UP] && p[ON_MOUSE_UP].call(y[ON_MOUSE_UP],
            w))
    };
    this.buttonDown = function() {
        e || (x.scaleX = .9 * d, x.scaleY = .9 * d, p[ON_MOUSE_DOWN] && p[ON_MOUSE_DOWN].call(y[ON_MOUSE_DOWN]))
    };
...
function CBetBut(a, b, c) {
    ...
    this.buttonRelease = function() {
        k[ON_MOUSE_UP] && !1 === f && (playSound("press_but", 1, !1), k[ON_MOUSE_UP].call(n[ON_MOUSE_UP], h))
    };
    this.buttonDown = function() {
...
function CMenu() {
    ...
    this._init = function() {
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) w = s_oSpriteLibrary.getSprite("audio_icon"), k = CANVAS_WIDTH - w.width / 4 - 10, n = w.height / 2 + 10, p = new CToggle(k,
            n, w, s_bAudioActive), p.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
        SHOW_CREDITS ? (w = s_oSpriteLibrary.getSprite("but_credits"), a = w.height / 2 + 10, b = w.height / 2 + 10, y = new CGfxButton(a, b, w, s_oStage), y.addEventListener(ON_MOUSE_UP, this._onButCreditsRelease, this), c = a + w.width + 10, f = b) : (c = w.height / 2 + 10, f = w.height / 2 + 10);
        w = window.document;
        var x = w.documentElement;
        h = x.requestFullscreen || x.mozRequestFullScreen || x.webkitRequestFullScreen || x.msRequestFullscreen;
        m = w.exitFullscreen || w.mozCancelFullScreen || w.webkitExitFullscreen ||
            w.msExitFullscreen;
        !1 === ENABLE_FULLSCREEN && (h = !1);
        h && screenfull.enabled && (w = s_oSpriteLibrary.getSprite("but_fullscreen"), l = new CToggle(c, f, w, s_bFullscreen, s_oStage), l.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease, this));
...
function CGame(a) {
    var b = !1,
        c, f, k, n, h, m, e, d, p, y, l, A, w, x, B, z, E, L, M, t, G = null;
    this._init = function() {
        c = GAME_STATE_IDLE;
        A = n = f = 0;
        z = [0, 1, 2, 3, 4];
    ...
    this._initReels = function() {
        var a = REEL_OFFSET_X,
            ...
            d = 0;
        w = [];
        for (var c = 0; c < NUM_REELS; c++) w[c] = new CReelColumn(c, a, b, d), w[c + NUM_REELS] = new CReelColumn(c + NUM_REELS, a, b + SYMBOL_SIZE * NUM_ROWS, d), a += SYMBOL_SIZE + SPACE_BETWEEN_SYMBOLS, d += REEL_DELAY
    };
    ...
    this.generateFinalSymbols = function() {
        ...
        for (var a = 0; a < NUM_ROWS; a++) {
            E[a] = [];
            for (var b = 0; b < NUM_REELS; b++) E[a][b] = s_aRandSymbols[Math.floor(Math.random() * s_aRandSymbols.length)]
        }
        B = [];
        for (a = l = 0; a < h; a++) {
            b = s_aPaylineCombo[a];
        ...
        if (f > MIN_REEL_LOOPS)
            if (k === b) {
                if (!1 === w[a].isReadyToStop()) {
                    var d = a;
                    a < NUM_REELS ? (d += NUM_REELS, w[d].setReadyToStop(), w[a].restart([E[0][a], E[1][a], E[2][a]], !0)) : (d -= NUM_REELS, w[d].setReadyToStop(), w[a].restart([E[0][d], E[1][d], E[2][d]], !0))
                }
    ...
    this.stopNextReel =
        function() {
            n++;
            0 === n % 2 && (playSound("reel_stop", 1, !1), k = z[n / 2], n === 2 * NUM_REELS && this._endReelAnimation())
        };
    this._endReelAnimation = function() {
        ...
        if (0 < B.length) {
            for (var a = 0; a < B.length; a++) {
                ...
                t.showLine(B[a].line);
                for (var b = B[a].list, e = 0; e < b.length; e++) x[b[e].row][b[e].col].show(b[e].value)
            }
            l *= d;
            y += l;
            SLOT_CASH -= l;
    ...
    this._hideAllWins = function() {
        for (var a =
                0; a < B.length; a++)
            for (var b = B[a].list, d = 0; d < b.length; d++) x[b[d].row][b[d].col].stopAnim();
        t.hideAllLines();
        e = m = 0;
        m = TIME_SHOW_WIN;
    ...
    this.changeCoinBet = function() {
        var a = Math.floor(100 *
            (d + .05)) / 100;
        a > MAX_BET ? (d = MIN_BET, p = d * h, p = parseFloat(p.toFixed(2)), t.refreshBet(d), t.refreshTotalBet(p), a = p) : (a *= h, a = parseFloat(a.toFixed(2)), d += .05, d = Math.floor(100 * d) / 100, p = a, t.refreshBet(d), t.refreshTotalBet(p));
    ...
    this.onSpin = function() {
        ...
        for (var a = 0; a < s_aSymbolWin.length; a++)
            for (var b = s_aSymbolWin[a], e = 0; e < b.length; e++) 0 !== b[e] && b[e] < MIN_WIN && (MIN_WIN = b[e]);
        MIN_WIN *= d;
        y -= p;
        t.refreshMoney(y);
        SLOT_CASH +=
    ...
    this._printSymbol = function() {
        for (var a = 0; a < NUM_ROWS; a++)
            for (var b = 0; b < NUM_REELS; b++) trace("_aFinalSymbolCombo[" + a + "][" + b + "]: " + E[a][b])
    };
    this.onInfoClicked =
        function() {
...
function CReelColumn(a, b, c, f) {
    ...
    this._updateStart = function() {
        ...
        l++;
        l > A && (l = 0, A /= 2, y++, w = z.y, x = w + SYMBOL_SIZE * NUM_ROWS);
    ...
    this._updateStopping = function() {
        l++;
        if (l >= A) k = !1, l = 0, A = MAX_FRAMES_REEL_EASE, y = REEL_STATE_START, p = 0, n = !1, h && (h = !1, z.y = REEL_OFFSET_Y), s_oGame.stopNextReel();
        else {
    ...
    this.update = function() {
        if (!1 !== k && (p++, p > d)) switch (!1 === n && z.y > REEL_ARRIVAL_Y && s_oGame.reelArrived(m,
            e), y) {
...
function CInterface(a, b, c) {
    var f, k, n, h, m, e, d, p, y, l, A, w, x, B, z, E = null,
        L = null,
        M, t, G, N, r, I;
    this._init = function(a, b, c) {
        ...
        !1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile ? (m = y.getX() - q.width, e = q.height / 2 + 2, x = new CToggle(m, e, s_oSpriteLibrary.getSprite("audio_icon"), s_bAudioActive), x.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this), f = m - q.width, k =
            e) : (f = y.getX() - q.width, k = q.height / 2 + 2);
        q = window.document;
        ...
        E && screenfull.enabled && (q = s_oSpriteLibrary.getSprite("but_fullscreen"), I = new CToggle(f, k, q, s_bFullscreen, s_oStage), I.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease, this));
        ...
        N = new CTLText(s_oStage, 460, CANVAS_HEIGHT - 120, 134, 30, 30, "center",
            "#ffffff", FONT_GAME, 1, 0, 0, NUM_PAYLINES, !0, !0, !1, !1);
        ...
        c.addEventListenerWithParams(ON_MOUSE_UP,
            this._onBetLineClicked, this, 10);
        d[9] = c;
        b += 43;
        c = new CBetBut(319 + q.width / 2, b, q, !0);
        ...
        d[14] = c;
        p = [];
        for (q = 0; q < NUM_PAYLINES; q++) a = createBitmap(s_oSpriteLibrary.getSprite("payline_" + (q + 1))), a.visible = !1, s_oStage.addChild(a), p[q] = a;
    ...
    this.refreshNumLines = function(a) {
        N.refreshText(a);
        for (var b = 0; b < NUM_PAYLINES; b++) b < a ? (d[b].setOn(), p[b].visible = !0) : d[b].setOff();
        setTimeout(function() {
    ...
    this.resetFullscreenBut = function() {
        E &&
            screenfull.enabled && I.setActive(s_bFullscreen)
    };
    this._onFullscreenRelease = function() {
...
function CPayTablePanel() {
    ...
    this._createPayouts = function() {
        ...
        for (var c = [{
            ...
            for (var m = [], e = 0; e < s_aSymbolWin[h].length; e++) m[e] = s_aSymbolWin[h][e];
            do e = m.indexOf(0), -1 !== e && m.splice(e, 1); while (-1 !== e);
            e = m.length;
            if (0 !== e) {
                var d = 30;
                4 === e && (d = 25);
                ...
                b[h] = [];
                for (var y = 0; y < e; y++) {
                    var l = new CTLText(f, c[n].x, p, 44, 25, 25, "left", "#ffffff",
                        FONT_GAME, 1, 0, 0, "X" + (5 - y), !0, !0, !1, !1);
                    a[h][y] = l;
    ...
    this.resetHighlightCombo = function() {
        for (var c = 0; c < a.length; c++)
            for (var f = 0; f < a[c].length; f++) a[c][f].setColor("#ffffff"), b[c][f].setColor("#ffff00"), createjs.Tween.removeTweens(b[c][f].getText()), b[c][f].setAlpha(1)
    };
...
function CStaticSymbolCell(a, b, c, f) {
    ...
    this._init = function(a, b, c, f) {
        ...
        for (a = 0; a < NUM_SYMBOLS; a++) b = createSprite(s_aSymbolAnims[a], "static", 0, 0, SYMBOL_SIZE, SYMBOL_SIZE), b.stop(), b.x = c, b.y = f, b.on("animationend", this._onAnimEnded, null, !1, {
            index: a
        }), e.addChild(b), h[a] = b, h[a].visible = !1;
        a = {
            framerate: 60,
    ...
    this.hide = function() {
        -1 < k && (m.gotoAndStop("static"), m.visible = !1, h[k].gotoAndPlay("static"), e.visible = !1)
    };
    ...
    this._onAnimEnded = function(a, b) {
        h[b.index].currentFrame !== n && (h[b.index].stop(), setTimeout(function() {
