...
function CTextButton(a, c, b, e, f, g, d) {
    ...
    this._init = function(a, d, b, c, e, f, g) {
        ...
        w = new createjs.Text(c, " " + g + "px " + e, "#000000");
        w.textAlign = "center";
        w.textBaseline = "alphabetic";
        var r = w.getBounds();
        w.x = b.width / 2 + v;
        w.y = Math.floor(b.height / 2) + r.height / 3 + v;
        p = new createjs.Text(c, " " + g + "px " + e, f);
        p.textAlign = "center";
        p.textBaseline = "alphabetic";
        r = p.getBounds();
        p.x = b.width / 2;
        p.y = Math.floor(b.height / 2) + r.height / 3;
    ...
    this.buttonRelease = function() {
        k || (n.scaleX = 1, n.scaleY = 1, q[ON_MOUSE_UP] && q[ON_MOUSE_UP].call(u[ON_MOUSE_UP]))
    };
    this.buttonDown = function() {
        k || (n.scaleX = .9, n.scaleY = .9, q[ON_MOUSE_DOWN] && q[ON_MOUSE_DOWN].call(u[ON_MOUSE_DOWN]))
    };
...
function CMenu() {
    ...
    this._init = function() {
        ...
        h = new CTextButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT - 124, p, TEXT_PLAY, FONT_GAME, "#ffffff", 40);
        h.addEventListener(ON_MOUSE_UP, this._onButPlayRelease, this);
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) p = s_oSpriteLibrary.getSprite("audio_icon"), f = CANVAS_WIDTH - p.width / 4 - 2, g = p.height / 2 + 2, q = new CToggle(f, g, p, s_bAudioActive),
            q.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
        SHOW_CREDITS ? (p = s_oSpriteLibrary.getSprite("but_credits"), a = p.height / 2 + 2, c = p.height / 2 + 2, u = new CGfxButton(a, c, p, s_oStage), u.addEventListener(ON_MOUSE_UP, this._onButCreditsRelease, this), b = a + p.width + 2, e = c) : (b = p.height / 2 + 2, e = p.height / 2 + 2);
        ...
        d && !1 === inIframe() && (p = s_oSpriteLibrary.getSprite("but_fullscreen"), n = new CToggle(b, e, p, s_bFullscreen, s_oStage), n.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease, this));
    ...
    this.refreshButtonPos = function(h, k) {
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || q.setPosition(f - h, k + g);
...
function CGame(a) {
    var c = !1,
        b, e, f, g, d, k, l, h, q, u, n, t, p, w, x, v, A, y, C, B, D, E, r, z = null;
    this._init = function() {
        b = GAME_STATE_IDLE;
        t = g = e = 0;
        A = [0, 1, 2, 3, 4];
    ...
    this._endReelAnimation = function() {
        ...
        u < q && r.disableSpin();
        t++;
        t === p && (t = 0, $(s_oMain).trigger("show_interlevel_ad"));
    ...
    this.changeCoinBet = function() {
        ...
        a > MAX_BET ? (h = MIN_BET, q = h * d, r.refreshBet(h), r.refreshTotalBet(q), a = q) : (a *= d, h += .05, h = Math.floor(100 * h) / 100, q = a, r.refreshBet(h), r.refreshTotalBet(q));
        a > u ? r.disableSpin() : r.enableSpin()
    };
    ...
    this.update = function() {
        if (!1 !== c) switch (b) {
            ...
            case GAME_STATE_SHOW_WIN:
                k += s_iTimeElaps, k > TIME_SHOW_WIN && (k = 0, this._showWin())
        }
    };
    s_oGame = this;
...
function CReelColumn(a, c, b, e) {
    var f, g, d, k, l, h, q, u, n, t, p, w, x, v;
    ...
    this._updateStart = function() {
        ...
        n++;
        n > t && (n = 0, t /= 2, u++, p = v.y, w = p + SYMBOL_SIZE * NUM_ROWS);
        var a = s_oTweenController.easeInBack(n, 0, 1, t),
            a = s_oTweenController.tweenValue(p, w, a);
        v.y = a
    };
    this._updateMoving =
        function() {
            n++;
            n > t && (n = 0, p = v.y, w = p + SYMBOL_SIZE * NUM_ROWS);
    ...
    this._updateStopping = function() {
        n++;
        if (n >= t) f = !1, n = 0, t = MAX_FRAMES_REEL_EASE, u = REEL_STATE_START, q = 0, g = !1, d && (d = !1, v.y = REEL_OFFSET_Y), s_oGame.stopNextReel();
        else {
    ...
    this.update = function() {
        if (!1 !== f && (q++, q > h)) switch (!1 === g && v.y > REEL_ARRIVAL_Y && s_oGame.reelArrived(k,
            l), u) {
...
function CInterface(a, c, b) {
    var e, f, g, d, k, l, h, q, u, n, t, p, w, x, v, A = null,
        y = null,
        C, B, D, E, r, z;
    this._init = function(a, b, c) {
        ...
        t = new CTextButton(272 + m.width / 2, 595, m, TEXT_INFO, FONT_GAME, "#ffffff", 30);
        t.addEventListener(ON_MOUSE_UP, this._onInfo, this);
        m = s_oSpriteLibrary.getSprite("but_lines_bg");
        p = new CTextButton(436 + m.width / 2, 595, m, TEXT_LINES, FONT_GAME, "#ffffff", 30);
        ...
        h[14] =
            c;
        q = [];
        for (m = 0; m < NUM_PAYLINES; m++) a = createBitmap(s_oSpriteLibrary.getSprite("payline_" + (m + 1))), a.visible = !1, s_oStage.addChild(a), q[m] = a;
        this.refreshButtonPos(s_iOffsetX, s_iOffsetY)
    };
    this.unload = function() {
        u.unload();
    ...
    this.refreshNumLines = function(a) {
        E.text = a;
        for (var b = 0; b < NUM_PAYLINES; b++) b < a ? (h[b].setOn(), q[b].visible = !0) : h[b].setOff();
        setTimeout(function() {
            for (var a = 0; a < NUM_PAYLINES; a++) q[a].visible = !1
        }, 1E3)
    };
        ...
        for (var b = [{
            ...
            if (0 !== h) {
                ...
                for (var n = 0; n < h; n++) {
                    ...
                    f.addChild(t);
                    a[e][n] = t;
                    var p = new createjs.Text(l[h - n - 1], "25px " + FONT_GAME, "#ffff00");
                    p.textAlign = "center";
                    p.x = t.x + 50;
                    p.y = t.y;
                    p.textBaseline = "alphabetic";
